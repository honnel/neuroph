...
/**
 * E-commerce recommender neural network based on hebbian learning. Still under
 * development, mostly hard-coded for now
 * 
...
public class RecommenderNetwork extends NeuralNetwork {
	...
	int inputLayerIdx = 0, typeLayerIdx = 1, brandLayerIdx = 2, priceLayerIdx = 3, promoLayerIdx = 4, outputLayerIdx = 5;
	...
	public void createDemoNetwork() {
		...
		// moze cak i posle svakog prolaza da se primenjuje hebbianovo pravilo a
		// ne samo nakon kupovine
		// napravi vise varijanti
		// ako kupuje onda moze da se primenjje winner takes all hebbian
		// learning
