...
public class Sample {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		inputFileName = "/Users/dominic/Downloads/converted.txt";
		// create training set from file
		DataSet cernDataSet = DataSet.createFromFile(inputFileName, 2853, 1, ",");
		TestAndTrainingSet tats = TestAndTrainingSet.splitSetAndPermute(
				cernDataSet, 0.5);

		// create MultiLayerPerceptron neural network
		MultiLayerPerceptron neuralNet = new MultiLayerPerceptron(2853, 2853, 1);
