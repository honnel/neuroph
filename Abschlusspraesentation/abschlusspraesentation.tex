...
\begin{document}
	...
	\begin{frame}[c]\frametitle{Code Analyse \& Profiling}
		\begin{block}{Profiling}
			...
			\begin{itemize}
			% TODO: Wer auch immer da hier verbrochen hat. Lies hier http://www.logophile.org/blog/2006/09/05/latex-math-mode-and-italics/
	...
	\framebreak
		...
		\begin{lstlisting}[caption={Layer::calculate()}]
		for (Neuron n : this.neurons) 
		    n.calculate();
 		\end{lstlisting}

 		\begin{lstlisting}[caption={ParallelLayer::calculate()}]
	...
	\begin{frame}[c]\frametitle{Technischer Vergleich der Strategien}	
		...
		%TODO: Buzzword für folgende Katergorie finden
		Selbes Ergebnis wie seriell? & ja & ja (batch) & nein \\
		%TODO fortsetzen
		\end{tabular}
